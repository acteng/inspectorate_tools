...
let pages: [string, string][] = [
  ...
  ["/planning/scorecard/q01", "1. Trip generation and assignment"],
  ["/planning/scorecard/q02", "2. Active travel route audit"],
  ["/planning/scorecard/q03", "3. Pedestrian access to local amenities"],
  ["/planning/scorecard/q04", "4. Cycling accessibility"],
  ["/planning/scorecard/q05", "5. Access to public transport"],
  ["/planning/scorecard/q06", "6. Off-site transport infrastructure"],
  ["/planning/scorecard/q07", "7. Site permeability"],
  ["/planning/scorecard/q08", "8. Placemaking"],
  ["/planning/scorecard/q09", "9. Cycle parking and trip-end facilities"],
  ["/planning/scorecard/q10", "10. Travel planning"],
