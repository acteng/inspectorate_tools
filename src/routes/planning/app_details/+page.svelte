...
<div class="govuk-width-container">
  ...
  <Select
    ...
    emptyOption
    choices={pairs(localPlanningAuthorities)}
    bind:value={$state.summary.localPlanningAuthority}
  />

  <Select
    label="Local highway authority"
    emptyOption
    choices={pairs(localHighwayAuthorities)}
